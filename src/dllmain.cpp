...
arcdps_exports* mod_init()
{
...

	{
		...
		if (HEAL_TABLE_OPTIONS.AutoUpdateSetting != AutoUpdateSettingEnum::Off)
		{
			...
			GlobalObjects::UPDATE_STATE = GlobalObjects::UPDATE_CHECKER->CheckForUpdate(GlobalObjects::SELF_HANDLE, GlobalObjects::VERSION, "Drevar/arcdps_healing_stats", enablePreReleases);
		}
	}
